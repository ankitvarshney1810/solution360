    ...
    <!-- Back to Top -->
    <button id="backToTop" onclick="window.scrollTo({top:0,behavior:'smooth'})"><i class="bi bi-arrow-up"></i></button>
    <footer class="footer">
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="footer-social">
                        ...
                        <a href="https://www.facebook.com/solution360ad" target="_blank" class="social-btn"><i class="bi bi-facebook"></i></a>
                    </div>
                </div>
                <div class="col-lg-2 col-md-6 col-6">
                  <div class="footer-heading">Company</div>
                  <a href="<?= base_url('main/about') ?>" class="footer-link">About Us</a>
                  <a href="<?= base_url('main/portfolio') ?>" class="footer-link">Portfolio</a>
                  <a href="<?= base_url('main/contact') ?>" class="footer-link">Contact Us</a>
                </div>
                <div class="col-lg-2 col-md-6 col-6">
                  <div class="footer-heading">Services</div>
                  <a href="<?= base_url('services/rwa-advertising') ?>" class="footer-link">RWA Ads</a>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="footer-contact-item">
                        ...
                        <span>113/6, Hari Nagar, Ext-II, Badarpur, South Delhi, Delhi – 110044</span>
                    </div>
                    <div class="footer-contact-item">
                        <i class="bi bi-telephone-fill"></i>
                        <span>+91-8377954127</span>
                    </div>
                    <div class="footer-contact-item">
                        <i class="bi bi-envelope-fill"></i>
                        <span>solution360india@gmail.com</span>
                    </div>
                </div>
            </div>
        </div>
        <div class="footer-bottom">
          <div class="container d-flex flex-wrap justify-content-between align-items-center gap-2">
            <p>© 2026 Solution360. All rights reserved.</p>
          </div>
        </div>
    </footer>
